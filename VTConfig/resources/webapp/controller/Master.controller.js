...
sap.ui.define([
		...
		return BaseController.extend("mt.vt.controller.Master", {
			...
			_getDialog: function() {
				if (!this._oDialog) {
					this._oDialog = sap.ui.xmlfragment("mt.vt.view.createEntry", this);
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("mt.vt.view.ViewSettingsDialog", this);
