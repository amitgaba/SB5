sap.ui.define([
		...
		return BaseObject.extend("mt.vt.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias mt.vt.model.ListSelector
			 */
			 ...
			 * @return {mt.vt.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
